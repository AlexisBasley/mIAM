...
const Nutrition: React.FC = () => {
  const nutritionData = {
    proteins: { value: 25, label: 'Protéines', color: 'bg-blue-500' },
    carbs: { value: 40, label: 'Glucides', color: 'bg-green-500' },
    fats: { value: 35, label: 'Lipides', color: 'bg-yellow-500' },
    fiber: { value: 28, label: 'Fibres (g)', color: 'bg-purple-500' },
  };
    ...
    <div className="py-12 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center mb-12">
          <h2 className="text-base text-blue-600 font-semibold tracking-wide uppercase">Nutrition</h2>
